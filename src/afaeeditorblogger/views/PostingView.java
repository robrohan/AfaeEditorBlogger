...
public class PostingView extends ViewPart implements IPropertyChangeListener {
	...
	private String[] titles = { "", IWeblog.ITEM_TITLE, IWeblog.ITEM_DATE,
	...
	class ViewContentProvider implements IStructuredContentProvider {
		...
		public Object[] getElements(Object parent) {
			if (postings == null) {
				return new Object[] { new Object[] { "Post no bills",
						"Post no bills", new Date(), "Post no bills" } };
			} else {
	...
	public void refreshView() {
		try {
			...
			e.printStackTrace();
			showMessage("The supplied RPC URL seems to be invalid. Please check your preferences setup.");
	...
	private void makeActions() {
		...
		refresh_action.setImageDescriptor(PlatformUI.getWorkbench()
				.getSharedImages().getImageDescriptor(
						ISharedImages.IMG_TOOL_REDO));
		// ///////////////////////////////////

		/*
		 * delete_action = new Action() { public void run() {
		 * showMessage("Not Implemented"); } }; delete_action.setText("Delete");
		 * delete_action.setToolTipText("Delete the entry");
		 * delete_action.setImageDescriptor
